...
if __name__ == "__main__":
	...
	parser.add_argument("--data_path", type=str, default="data/kinematic_model_data_train_3/", help="Path to the data")
	parser.add_argument("--verbose", type=bool, default=True, help="Print statistics")
