...
wandb_links=("vaydingul/mbl/1jnw0xjn")
batch_sizes=(300)
checkpoint_numbers=(4 9 14 19 24 29 34 39 44 49 54 59 64 69 74 79 84 89)
# checkpoint_numbers=(4 9 14 19 24 29 34)
# thresholds=(0.1 0.25 0.5)

thresholds=(0.5)
vehicle_thresholds=(0.25)

FOLDER_NAME="world_forward_model_extended_bev_evaluation_extensive_5Hz_with_iou_report_specialized_threshold"
