...
wandb_links=("vaydingul/mbl/kesa7b2p") 
batch_sizes=(140)
checkpoint_numbers=(47 41 35 29 23 17 11 5)	

thresholds=(0.5)
vehicle_thresholds=(0.5)

FOLDER_NAME="world_forward_model_extended_bev_evaluation_extensive_20Hz_with_metrics"
	...
	for ((i = 0; i < $length_wandb_links; i++)); do
		for ((k = 0; k < $length_thresholds; k++)); do
			...
			python3 eval_world_forward_model.py \
				...
				--data_path_test="data/ground_truth_bev_model_test_data_20Hz_multichannel_bev_dense_traffic/" \
