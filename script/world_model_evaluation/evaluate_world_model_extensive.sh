...
wandb_links=(vaydingul/mbl/2807bkg4)
batch_sizes=(300)
checkpoint_numbers=(64)
...
FOLDER_NAME="world_forward_model_extended_bev_evaluation_extensive_5Hz_with_iou_report_specialized_threshold_0.01"
