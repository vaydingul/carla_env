...
wandb_links=("vaydingul/mbl/2xpqn2jg")
checkpoint_numbers=(4 9 14 19 24 29 34 39 44 49 54 59 64 69 74)
# checkpoint_numbers=(4 9 14 19 24 29 34)
# thresholds=(0.1 0.25 0.5)
thresholds=(0.5)

FOLDER_NAME="world_forward_model_evaluation_extensive_extended_horizon_5Hz_with_iou_report"
	...
	for ((k = 0; k < $length_thresholds; k++)); do
		for ((j = 0; j < $length_checkpoint_numbers; j++)); do
			...
			python3 eval_world_forward_model.py \
				...
				--data_path_test="data/ground_truth_bev_model_test_data_10Hz/" \
