...
wandb_links=("vaydingul/mbl/r4la61x3")
checkpoint_numbers=(19 24 29 34 39 44 49)
	...
	for ((k = 0; k < $length_thresholds; k++)); do
		for ((j = 0; j < $length_checkpoint_numbers; j++)); do
			...
			python3 eval_world_forward_model.py \
				...
				--save_path="figures/world_forward_model_evaluation_extensive_new_dataset_with_iou_report/${wandb_links[i]}/${thresholds[k]}/" \
				--test_set_step=10 \
				--report_iou=true \
