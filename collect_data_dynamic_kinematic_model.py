...
def main(config):
    ...
    np.savez(f"{config.data_save_path}/dynamic_kinematic_model_data", vehicle_location=vehicle_location, vehicle_rotation = vehicle_rotation, vehicle_velocity=vehicle_velocity,
