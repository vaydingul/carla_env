...
if __name__ == "__main__":
	...
	for k in range(elapsed_time.shape[0]):
		...
		kinematic_bicycle_location[k, :] = kinematic_bicycle_model.x, kinematic_bicycle_model.y
		dynamic_bicycle_location[k, :] = dynamic_bicycle_model.x, dynamic_bicycle_model.y
