...
@hydra.main(config_path="config", config_name="train_rl_acmpc")
def main(cfg: DictConfig):
    ...
    # prepare agent
    agent_name = cfg.actors[cfg.ev_id].driver
    ...
    if last_checkpoint_path.exists():
        with open(last_checkpoint_path, "r") as f:
            cfg.driver[agent_name].wb_run_path = f.read()

    OmegaConf.save(config=cfg.driver[agent_name], f="config_agent.yaml")

    # single agent
    AgentClass = config_utils.load_entry_point(cfg.driver[agent_name].entry_point)
