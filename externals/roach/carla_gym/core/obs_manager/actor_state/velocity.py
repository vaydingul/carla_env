...
class ObsManager(ObsManagerBase):
        ...
        self.obs_space = spaces.Dict(
            {
                ...
                "vel_ang_z": spaces.Box(
                    low=-1e3, high=1e3, shape=(1,), dtype=np.float32
                ),
            }
        )
    ...
    def get_observation(self):
        ...
        acc_w = self._parent_actor.get_acceleration()
        vel_w = self._parent_actor.get_velocity()
        ang_w = self._parent_actor.get_angular_velocity()
