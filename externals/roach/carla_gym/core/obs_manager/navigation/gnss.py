...
from externals.roach.carla_gym.core.task_actor.common.navigation.map_utils import RoadOption
...
class ObsManager(ObsManagerBase):
    ...
    def get_observation(self):
        ...
        next_vec_in_global = gps_util.gps_to_location(next_gps) - gps_util.gps_to_location(gnss_data)
