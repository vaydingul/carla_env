...
class CarlaEnvironment(Environment):
	...
	def reset(self):
		...
		self.rgb_sensor_1 = rgb_sensor.RGBSensorModule(
			config={"yaw": -60}, client=self.client, actor=self.hero_actor_module)
		self.rgb_sensor_2 = rgb_sensor.RGBSensorModule(
			config={"yaw": 0}, client=self.client, actor=self.hero_actor_module)
		self.rgb_sensor_3 = rgb_sensor.RGBSensorModule(
			config={"yaw": 60}, client=self.client, actor=self.hero_actor_module)
		self.rgb_sensor_4 = rgb_sensor.RGBSensorModule(
			config={"yaw": 120}, client=self.client, actor=self.hero_actor_module)
		self.rgb_sensor_5 = rgb_sensor.RGBSensorModule(
			config={"yaw": 180}, client=self.client, actor=self.hero_actor_module)
		self.rgb_sensor_6 = rgb_sensor.RGBSensorModule(
			config={"yaw": 240}, client=self.client, actor=self.hero_actor_module)
