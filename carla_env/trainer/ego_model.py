...
class Trainer(object):
    ...
    def train(self, run):
        ...
        for i, (data) in enumerate(self.dataloader_train):
            ...
            ego_action = data["ego"]["control_array"][:,
                                                      :self.num_time_step_future].to(self.device)
            ...
            loss_rotation = self.loss_criterion(torch.cos(ego_future_yaw), torch.cos(
                ego_future_yaw_predicted))
            loss_rotation += self.loss_criterion(torch.sin(ego_future_yaw), torch.sin(
                ego_future_yaw_predicted))
